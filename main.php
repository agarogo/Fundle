...
<div class="opup-bg4 rounded-2xl">
    <div class="opup4">
        ...
        <div class="flex h-4/6">
            <p>Проверка заданий происходит админами</p>
        </div>
        <div class=" h-2/6">
            <div class="flex mt-5 mr-2 ml-2">
                <p class="text-2xl text-blue-400 gert mt-1 w-2/5">Задание</p>
                <p class="ml-auto text-2xl w-3/5">300 F</p>
            </div>
            <div class="flex mt-5 mr-2 ml-2">
                <p class="mt-5"></p>
                <form action="1.php" class="flex ml-auto">
                    <button class="h-10 w-32 ml-auto rounded-full text-black gert"style="background-color: #0061FE;">Начать</button>
                </form>
            </div>
        </div>
    </div>
